...
function getReply(command) {
    ...
    function addEvent(event) {
        ...
        return event.name + " is added to calendar on " +event.date;
    }
...
console.log(getReply('What is on my todo?'));                           // Fishing

console.log(getReply('What day is it today?'));                         // Today is 26 of September, 2019

console.log(getReply('What is 40+70+40+70'));                            // 50

console.log(getReply('What is 40*10*5'));                                 // 400

console.log(getReply('My favorite dish is biryani'));                    //  Biryani

console.log(getReply('What is my favorite dish?'));                       // your favourite dish is chicken biryani.

console.log(getReply('Set a timer for 1 minutes'));                     // Timer set for 4 minutes.
